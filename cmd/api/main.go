...
func main() {
	...
	flag.StringVar(&cfg.db.maxIdleTime, "db-max-idle-time", "15m", "PostgreSQL max connection idle time, e.g. 10m or 5s")
	...
	flag.IntVar(&cfg.smtp.port, "smtp-port", cfg.GetInt("SMTP_PORT"), "SMTP port")
